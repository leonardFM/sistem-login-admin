        ...
        <div class="container-fluid">
          ...
          <div class="row">
          	<div class="col-lg-6">
          		...
          		<a href="" class="btn btn-outline-primary mb-3" data-toggle="modal" data-target="#addRoleModal">Add New Menu</a>
			  ...
			  <div class="modal-dialog modal-dialog-centered" role="document">
			    <div class="modal-content">
			      <div class="modal-header">
			        <h5 class="modal-title" id="exampleModalCenterTitle">Add New Role Management</h5>
			      ...
			      <form action="<?= base_url('admin/role'); ?>" method="post">
				      <div class="modal-body">
				        <div class="form-group">
						    ...
						    <small id="text" class="form-text text-muted ml-2">Enter a new Role</small>
						  </div>
				      </div>
